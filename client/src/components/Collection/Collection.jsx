        ...
        <div class="fn__collection_item">
            <div class="title_holder">
                <div class="author_img">
                    ...
                    <span class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg"  enable-background="new 0 0 515.556 515.556" height="512" viewBox="0 0 515.556 515.556" width="512" class="fn__svg replaced-svg"><path d="m0 274.226 176.549 176.886 339.007-338.672-48.67-47.997-290.337 290-128.553-128.552z"></path></svg>
                    </span>
                ...
                <div class="author_info">
                    ...
                    <p>Created by <a href="author-collected.html">{props.element[3]}</a></p>
                </div>
                {/* <a href="#" class="anor_fn_like" data-id="" data-title="{props.element[0]}">
